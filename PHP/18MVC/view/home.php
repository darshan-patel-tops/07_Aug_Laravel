<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(<?php echo $this->baseurl;  ?>images/slide1-01.jpg);">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(<?php echo $this->baseurl;  ?>images/master-slides-02.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(<?php echo $this->baseurl;  ?>images/master-slides-01.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
			...
			<div class="row">
				...
				<div class="col-md-6 p-b-30">
					<div class="wrap-pic-welcome size2 bo-rad-10 hov-img-zoom m-l-r-auto">
						<img src="<?php echo $this->baseurl;  ?>images/our-story-01.jpg" alt="IMG-OUR">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="<?php echo $this->baseurl;  ?>images/intro-02.jpg" alt="IMG-INTRO"></a>
							</div>
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="<?php echo $this->baseurl;  ?>images/intro-04.jpg" alt="IMG-INTRO"></a>
							</div>
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="<?php echo $this->baseurl;  ?>images/our-menu-01.jpg" alt="IMG-MENU">
						...
						<div class="col-sm-6">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="<?php echo $this->baseurl;  ?>images/our-menu-05.jpg" alt="IMG-MENU">
						...
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="<?php echo $this->baseurl;  ?>images/our-menu-13.jpg" alt="IMG-MENU">
				...
				<div class="col-md-4">
					<div class="row">
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="<?php echo $this->baseurl;  ?>images/our-menu-08.jpg" alt="IMG-MENU">
						...
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="<?php echo $this->baseurl;  ?>images/our-menu-10.jpg" alt="IMG-MENU">
						...
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="<?php echo $this->baseurl;  ?>images/our-menu-16.jpg" alt="IMG-MENU">
