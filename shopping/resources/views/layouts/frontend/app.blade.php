    ...
    <div class="border-bottom ">
            ...
            <div class="container">
                <div class="row"> --}}
                    ...
                    {{-- <div class="col-md-6 col-12 text-center text-md-start">
                     <h1>
                       <span>Super Saver Days Are Live!!!</span>
                      </h1>
                    </div> --}}

                    {{-- <div class="col-6 text-end d-none d-md-block">
                      <div class="btn btn-primary" aria-expanded="true" >
        ...
        <div class="py-4 pt-lg-3 pb-lg-0">
                ...
                <div class="row w-100 align-items-center gx-lg-2 gx-0">
                    ...
                    <div class="col-xxl-6 col-lg-5 d-none d-lg-block">
                      ...
                      @endif
                        ...
                        <form action="{{url('search')}}" value="{{Request::get('search')}}" method="GET" role="search">
                            <div class="input-group ">
                                <input class="form-control rounded" name="search" value="" type="search"
                      ...
                      {{-- <div class="col-6 text-end d-none d-md-block"> --}}
                        <div class="btn btn-primary" aria-expanded="true" >
                          ...
                          <select class="form-select changeLanguage">
                            ...
                            <option value="sp" {{ session()->get('locale') == 'sp' ? 'selected' : ''}}>Spanich</option>
                            <option value="sp" {{ session()->get('locale') == 'sp' ? 'selected' : ''}}>russian</option>
                            </ul>
                          </select>
          ...
          <div class="list-inline-item">
            ...
            <div class="list-inline-item">
                <a href="{{url('/cart')}}" class="text-muted position-relative " >
        ...
        <nav class="navbar navbar-expand-lg navbar-light navbar-default py-0 py-lg-4">
            <div class="container px-0 px-md-3">
              ...
              <div class="dropdown me-3 d-none d-lg-block">
                    <button class="btn btn-primary px-6 " href="/category" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
          <span class="me-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
            ...
            All Categories
              ...
              <li class="nav-item">
                <a class="nav-link" href="/new-arrival">
                    New Arrivals
                </a>
              </li>
...
window.addEventListener('message', event => {
  ...
  alertify.notify(event.detail.text,event.detail.type,1);
});
</script>
<script>
